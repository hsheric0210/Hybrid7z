namespace Hybrid7z
{
	public class Config
	{
		...
		public static void saveDefaults(string path)
		{
			...
			ini.write("LZMA2", "-m0=LZMA2 -mx=9 -myx=9 -md=1024m -mfb=273 -mmt=8 -mmtf=on -mmf=bt4 -mmc=10000 -mlc=4", "Parameters");
			ini.write("Copy", "-m0=Copy -mx=0", "Parameters");
			ini.write("x86", "-mf=BCJ2 -m0=LZMA2 -mx=9 -myx=9 -md=1024m -mfb=273 -mmt=8 -mmtf=on -mmf=bt4 -mmc=10000 -mlc=4", "Parameters");
			ini.write("FastLZMA2", "-m0=FLZMA2 -mx=9 -myx=9 -md=1024m -mfb=273 -mmt=32 -mmtf=on -mlc=4", "Parameters");
